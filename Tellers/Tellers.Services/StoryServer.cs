...
namespace Tellers.Services
{
    public class StoryServer : IStoryServer
    {
        ...
        public StoryServer(TellersDbContext data, IMapWrapper mapper)
        {
            this.data = data;
        ...
        /// <summary>
        /// Service method that returns all stories as no tracking set.
        /// </summary>
        /// <returns></returns>
        public async Task<IEnumerable<StoryCardViewModel>> All()
        {
            return this.mapper.GetModels<StoryCardViewModel, Story>(await data
                                                                            .Stories
                                                                            .AsNoTracking()
                                                                            .ToListAsync());
        }
        ...
        {
            return this.mapper.GetModels<StoryCardViewModel, Story>(await this.data.Stories
                                                                                .Include(s => s.Revues)
                                                                                .ThenInclude(r => r.Profile)
                                                                                .Include(s => s.Authors)
                                                                                .Include(s => s.Creator)
                                                                                .Include(s => s.StoryType)
                                                                                .ThenInclude(st => st.Genres)
                                                                                .Include(s => s.Readers)
                                                                                .AsNoTracking()
