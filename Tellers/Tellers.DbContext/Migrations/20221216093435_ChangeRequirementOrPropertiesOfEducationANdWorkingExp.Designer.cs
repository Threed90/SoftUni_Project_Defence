...
namespace Tellers.DbContext.Migrations
{
    ...
    [Migration("20221216093435_ChangeRequirementOrPropertiesOfEducationANdWorkingExp")]
    partial class ChangeRequirementOrPropertiesOfEducationANdWorkingExp
    {
            ...
            modelBuilder.Entity("ProfileStory1", b =>
                {
                    ...
                    b.Property<Guid>("MyStoriesId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("AuthorsId", "MyStoriesId");

                    b.HasIndex("MyStoriesId");
